...
class SimpleChatBot:
    ...
    def find_best_answer(self, input_question):
        ...
        for question in self.questions :
            levenshtein_distances.append(self.calc_distance(input_question, question))  # 레벤슈타인 거리 값들을 저장
        best_match_index = np.array(levenshtein_distances).argmin()   # 레벤슈타인 거리 값이 가장 작은 값의 인덱스를 반환
